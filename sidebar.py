...
class SidebarView(ctk.CTkFrame):
    def __init__(self, parent, db, on_add_callback, on_currency_change, on_open_export):
        ...
        # Title
        ctk.CTkLabel(self, text="??? VaultFlow", font=ctk.CTkFont(size=22, weight="bold"), text_color="#38bdf8").grid(row=0, column=0, padx=20, pady=(20, 15), sticky="w")
        ...
        # Date Entry
        ctk.CTkLabel(self, text="Date (YYYY-MM-DD):", font=ctk.CTkFont(size=11), text_color="#9ca3af").grid(row=8, column=0, padx=20, pady=(0, 2), sticky="w")
        self.date_entry = ctk.CTkEntry(self)
        self.date_entry.insert(0, datetime.now().strftime("%Y-%m-%d"))
        self.date_entry.grid(row=9, column=0, padx=20, pady=(0, 10), sticky="ew")

        # Description Entry
        ctk.CTkLabel(self, text="Description:", font=ctk.CTkFont(size=11), text_color="#9ca3af").grid(row=10, column=0, padx=20, pady=(0, 2), sticky="w")
        self.desc_entry = ctk.CTkEntry(self, placeholder_text="e.g. Monthly Rent, Client Fee")
        self.desc_entry.grid(row=11, column=0, padx=20, pady=(0, 15), sticky="ew")
        ...
        self.add_btn.grid(row=12, column=0, padx=20, pady=(0, 15), sticky="ew")
        ...
        self.export_btn.grid(row=14, column=0, padx=20, pady=(0, 20), sticky="ew")
    ...
    def submit(self):
        ...
        self.db.add_transaction(tx_type, date_str, category, amt, desc)
